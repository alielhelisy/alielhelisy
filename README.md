...
Computer Engineering student building practical projects across web development, databases, object-oriented programming, networking, and performance analysis.

I like turning course ideas into working systems: database-backed apps, clean OOP designs, simulations, and small experiments that make computer systems easier to understand.
...
| Project | Focus | Tech |
|---|---|---|
| [Football Scouting App](https://github.com/alielhelisy/Football-Scouting-App) | Multi-user scouting web application with players, reports, search, admin roles, and SQL Server integration | Python, Flask, SQL Server, HTML, CSS, pytest |
| [Scouting App SAD](https://github.com/alielhelisy/Scouting-App-SAD) | Software analysis and design work for the scouting application | JavaScript, system design |
...
- Full-stack web applications connected to real databases
- Database schema design and ER/EER modeling
- Object-oriented design and clean project structure
- Computer networks, routing, and performance measurement
- Parallel programming and system optimization

## Contact

- Email: [elhelesya@gmail.com](mailto:elhelesya@gmail.com)
- GitHub: [github.com/alielhelisy](https://github.com/alielhelisy)
- LinkedIn: [Ali Elhelisy](https://www.linkedin.com/in/ali-elhelisy-8ba760405)
